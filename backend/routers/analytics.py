...
def _fetch_performance_sync(period: str) -> Dict[str, Any]:
    """Sync function to fetch performance analytics - called via asyncio.to_thread()"""
...
async def get_performance(period: str = "1M"):
    ...
    """
    try:
        return await asyncio.to_thread(_fetch_performance_sync, period)
